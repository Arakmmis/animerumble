...
let skills = {
  ...
  skill4: {
    ...
    cooldown: 2,
    description:
      'Krillin takes a senzu bean for himself or a team mate and making them gain 1 energy, then they will heal 15 health over 2 turns. This skill can only be used thrice in a game.',
    target: 'ally',
    usage: 0,
